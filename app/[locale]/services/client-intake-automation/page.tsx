...
export async function generateMetadata({
  ...
  return {
    title: t("intake_title"),
    description: t("intake_desc"),
    alternates: {
      canonical: `${DOMAIN}/${locale}/services/client-intake-automation`,
      languages: {
        en: `${DOMAIN}/en/services/client-intake-automation`,
        es: `${DOMAIN}/es/services/client-intake-automation`,
        "x-default": `${DOMAIN}/en/services/client-intake-automation`,
      },
    },
  };
}

export default async function ClientIntakeAutomationPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  const solutionItems: string[] = t.raw("intake.solution_items") as string[];
      ...
      <div className="pt-32 pb-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-20">
          <div>
            ...
            >
              {t("intake.problem_headline")}
            </h2>
            <p className="text-[--color-muted] leading-relaxed">{t("intake.problem_body")}</p>
          </div>
          <div>
            <h2
              className="text-xl font-bold text-[--color-steel] mb-4"
        ...
        <div className="bg-white/5 border border-[--color-border] rounded-2xl p-8 mb-16">
          <h2
            ...
            style={{ fontFamily: "Syne, sans-serif" }}
          >
            {t("intake.workflow_headline")}
          </h2>
          <p className="text-[--color-muted] leading-relaxed">{t("intake.workflow_body")}</p>
        </div>
