...
export async function generateMetadata({
  ...
  return {
    ...
    description: t("operations_desc"),
    alternates: {
      canonical: `${DOMAIN}/${locale}/services/operations-automation`,
      languages: {
        en: `${DOMAIN}/en/services/operations-automation`,
        es: `${DOMAIN}/es/services/operations-automation`,
        "x-default": `${DOMAIN}/en/services/operations-automation`,
      },
    },
  };
}
...
export default async function OperationsAutomationPage({
  ...
  const solutionItems: string[] = t.raw("operations.solution_items") as string[];
      ...
      <div className="pt-32 pb-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-20">
          <div>
            ...
            >
              {t("operations.problem_headline")}
            </h2>
            <p className="text-[--color-muted] leading-relaxed">{t("operations.problem_body")}</p>
          </div>
          <div>
            <h2
              className="text-xl font-bold text-[--color-steel] mb-4"
              style={{ fontFamily: "Syne, sans-serif" }}
            >
              {t("operations.solution_headline")}
            </h2>
        ...
        <div className="bg-white/5 border border-[--color-border] rounded-2xl p-8 mb-16">
          <h2
            ...
            style={{ fontFamily: "Syne, sans-serif" }}
          >
            {t("operations.workflow_headline")}
          </h2>
          <p className="text-[--color-muted] leading-relaxed">{t("operations.workflow_body")}</p>
        </div>
